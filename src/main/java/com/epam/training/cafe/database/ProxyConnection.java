...
public class ProxyConnection implements Connection {
    ...
    /**
     * Return connection back to pool instead of releasing {@code Connection}
     * object's database. For releasing {@code Connection} object use
     * {@link #reallyClose()} method.
     *
     * @exception SQLException
     *                if fail to return connection to pool.
     */
    @Override
    public void close() throws SQLException {
        ...
        try {
            ...
            throw new SQLException("Fail to close connection.", e);
        }
    }
